...
insert_png("./static/assets/images/EEGCSP2.png", "5%")
insert_image_title(
...
insert_png("./static/assets/images/SDS2.png", "5%")
insert_image_title(
...
insert_png("./static/assets/images/amp3.png", "5%")
insert_image_title(
...
insert_png("./static/assets/images/log2.png", "5%")
insert_image_title(
...
insert_png("./static/assets/images/accuracyM1.png")
insert_image_title(
